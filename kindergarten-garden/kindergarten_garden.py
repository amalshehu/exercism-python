...
#  Purpose:    Write a program that, given a diagram, can tell you which plants each students in the kindergarten class is responsible for.
...
class Garden(object):
    ...
    def plants(self, students):
        ...
        plant = [self.plant_names[item] for item in (self.cup_row[0][cup] + self.cup_row[1][cup])]
        return plant
